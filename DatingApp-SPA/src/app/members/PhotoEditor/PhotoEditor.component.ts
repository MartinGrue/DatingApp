...
SetMainPhoto(mainPhoto: Photo){
  this.userService.setisMainPhoto(mainPhoto.id, this.authservice.decodedToken.nameid)
  .subscribe(() => {console.log('Main updated');
...
DeletePhoto(photoId: number) {
  this.alertify.confirm('Are you sure?',
   () => {this.userService.deletePhoto(photoId,
